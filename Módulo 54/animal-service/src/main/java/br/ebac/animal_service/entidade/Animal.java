package br.ebac.animal_service.entidade;
...
public class Animal {
    ...
    @Column(nullable = false)
    private String condicoesChegadas;
    ...
    public String getCondicoesChegadas() {
        return condicoesChegadas;
    }

    public void setCondicoesChegadas(String condicoesChegadas) {
        this.condicoesChegadas = condicoesChegadas;
    }
